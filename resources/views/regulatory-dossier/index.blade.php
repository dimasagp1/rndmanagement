    ...
    <div class="max-w-[1200px] mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div class="flex items-center gap-3 ml-auto">
                <!-- Add File -->
                <button onclick="document.getElementById('uploadModal').classList.remove('hidden')" class="inline-flex items-center justify-center gap-2 px-12 py-2.5 rounded-xl text-white text-sm font-medium shadow-sm transition" style="background-color: #2F7D46;">
