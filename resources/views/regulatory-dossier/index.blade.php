    ...
    <div class="max-w-[1200px] mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div class="flex items-center gap-3 ml-auto">
                <!-- Add File -->
                <button onclick="document.getElementById('uploadModal').classList.remove('hidden')" class="inline-flex items-center justify-center gap-2 px-16 py-2.5 rounded-xl text-white text-sm font-medium shadow-sm transition" style="background-color: #2F7D46;">
            ...
            @else
                ...
                <div class="grid gap-4 mb-8" style="grid-template-columns: repeat(auto-fill, minmax(180px, 220px));">
                    @foreach($folders as $index => $folder)
                        <a href="{{ route('regulatory-dossier.index', ['folder' => $folder->id]) }}" class="group bg-white border border-gray-100 rounded-2xl px-3 py-3 hover:shadow-sm hover:border-gray-200 transition flex flex-col" style="min-height: 170px;">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 p-4">
                                @foreach($documents as $doc)
                                    <div class="group border border-gray-100 rounded-2xl p-3 hover:shadow-sm hover:border-gray-200 transition overflow-hidden min-w-0">
                                        ...
                                        <a href="{{ route('regulatory-dossier.documents.show', $doc) }}" class="text-sm font-medium hover:text-primary line-clamp-2 leading-tight" style="color: #1F2A22;">{{ $doc->original_name }}</a>
                            ...
                            <div class="divide-y divide-gray-50">
                                @foreach($documents as $doc)
                                    <div class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition group">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <a href="{{ route('regulatory-dossier.documents.show', $doc) }}" class="text-sm font-medium hover:text-primary truncate block" style="color: #1F2A22;">{{ $doc->original_name }}</a>
                                        ...
                                        <a href="{{ route('regulatory-dossier.documents.download', $doc) }}" class="w-8 h-8 rounded-full bg-white border flex items-center justify-center hover:bg-gray-50">
