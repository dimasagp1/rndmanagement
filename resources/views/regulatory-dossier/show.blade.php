<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-1.5 text-sm text-gray-500 flex-wrap">
            <a href="{{ route('regulatory-dossier.index') }}"
            ...
            @foreach($breadcrumbs as $crumb)
                ...
                <a href="{{ route('regulatory-dossier.index', ['folder' => $crumb->id]) }}"
    ...
    <div class="bg-white border border-gray-100 rounded-2xl p-4 sm:p-5 mb-5">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            {{-- Back Button --}}
            <a href="{{ route('regulatory-dossier.index', ['folder' => $document->folder_id]) }}"
                ...
                <div class="p-4 sm:p-5">
                        ...
                        <div>
                            ...
                            <dd class="font-medium text-ink mt-1">
                                ...
                                @if($document->folder)
                                    ...
                                    <a href="{{ route('regulatory-dossier.index', ['folder' => $document->folder->id]) }}"
                    ...
                    <div class="flex flex-wrap items-center gap-2
                        ...
                        @if($document->is_previewable)
                            ...
                            <a href="{{ route('regulatory-dossier.documents.preview', $document) }}"
                               target="_blank"
                        ...
                        {{-- Download --}}
                        <a href="{{ route('regulatory-dossier.documents.download', $document) }}"
                           class="inline-flex items-center gap-2
                                  px-3.5 py-2
                                  rounded-xl
                        ...
                        {{-- Delete --}}
                        <form method="POST"
                              action="{{ route('regulatory-dossier.documents.destroy', $document) }}"
                    ...
                    <div class="divide-y divide-gray-50">
                        ...
                        @foreach($document->versions as $version)
                            ...
                            <div class="px-4 sm:px-5 py-3.5
                                ...
                                {{-- Download Version --}}
                                <a href="{{ route('regulatory-dossier.versions.download', $version) }}"
            ...
            <div class="bg-white border border-gray-100
                ...
                <div class="p-3 sm:p-4">
                    ...
                    @if(strtolower($document->extension ?? '') === 'pdf')
                        ...
                        <iframe
                            src="{{ route('regulatory-dossier.documents.preview', $document) }}"
    ...
    <div id="renameModal"
        ...
        <div class="bg-white rounded-2xl
            ...
            <form method="POST"
                  action="{{ route('regulatory-dossier.documents.update', $document) }}"
                  class="mt-4">
    ...
    <div id="moveModal"
        ...
        <div class="bg-white rounded-2xl
            ...
            <form method="POST" action="{{ route('regulatory-dossier.documents.move', $document) }}" class="mt-4 space-y-4">
                @csrf
                <div>
