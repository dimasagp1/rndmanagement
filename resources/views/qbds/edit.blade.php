<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span class="text-ink font-medium">Edit QbD</span>
        </div>
    </x-slot>

    <div class="min-h-screen max-w-3xl">
        <header class="mb-8">
            <h1 class="text-2xl font-heading font-bold text-ink mb-1">Edit QbD</h1>
            <p class="text-sm text-gray-500">
                Perbarui nama produk. Lampiran dapat ditambahkan dari halaman detail.
            </p>
        </header>

        <form method="POST" action="{{ route('qbds.update', $qbd) }}" class="space-y-6">
            @csrf @method('PUT')
            ...
            <div class="card card-body space-y-5">
                <div>
                    ...
                    <input type="text" id="product_name" name="product_name" required
                           ...
                           value="{{ old('product_name', $qbd->product_name) }}"
