        ...
        <div class="logo-area">
            @if(setting('print_logo'))
                <img src="{{ asset('storage/' . setting('print_logo')) }}"
                    style="height: 10mm; width: auto; max-width: 28mm; object-fit: contain; vertical-align: middle;">
            @else
            ...
            <tr>
                <td>
                    ...
                    <div class="form-container">
                        ...
                        <div class="section-title">A. IDENTITAS SAMPEL TRIAL <span class="section-subtitle">(diisi oleh
                                Staff R&D)</span></div>
                        <div class="field-row">
                        ...
                        <div class="section-title">B. TUJUAN TRIAL <span class="section-subtitle">(diisi oleh Staff
                                R&D)</span></div>
                        <div style="border: 1px solid #000; padding: 2mm; min-height: 20mm; white-space: pre-line;">
                            {{ $trialRm->trial_objective ?? '' }}
                        </div>

                        <div class="mt-3 mb-3"></div>

                        {{-- Section C: FORMULA TRIAL --}}
                        <div class="section-title">C. FORMULA TRIAL <span class="section-subtitle">(diisi oleh Staff
                                R&D)</span></div>
                        ...
                        <div class="section-title">D. TAHAPAN PROSES <span class="section-subtitle">(diisi oleh Staff
                                R&D)</span></div>
                        <div
                            style="border: 1px solid #000; padding: 2mm; min-height: 30mm; white-space: pre-line; font-size: 9pt;">
                            {{ $trialRm->process_steps }}</div>
                    </div>
                    ...
                    <div class="form-container">
                        ...
                        <div class="section-title">E. HASIL TRIAL <span class="section-subtitle">(diisi oleh Staff
                                R&D)</span></div>
                        <table class="data-table">
                            <thead>
                                <tr>
                                ...
                                @foreach($trialRm->verifications as $v)
                                    <tr>
                                        ...
                                        <td>{{ $v->actual_value }}
                                            @if($v->status)
                                                <span
                                                    style="font-size: 8pt; color: {{ $v->status === 'Pass' ? '#16a34a' : ($v->status === 'Fail' ? '#dc2626' : '#d97706') }};">({{ $v->status }})</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <p style="font-size: 8pt; margin-top: 1mm; font-style: italic;">Keterangan: Parameter Fisika,
                            Kimia dan Mikrobiologi (pengujian dilakukan setelah parameter pemerian produk disetujui oleh
                            Manager QR&D)</p>

                        <div class="mt-3 mb-3"></div>

                        {{-- Section F: KESIMPULAN --}}
                        <div class="section-title">F. KESIMPULAN <span class="section-subtitle">(diisi oleh R&D)</span>
                        </div>
                        <table class="data-table" style="font-size: 9pt;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle; font-size: 8pt;">
                                        @if($trialRm->creator?->signature_path)
                                            <img src="{{ $resolveSigUrl($trialRm->creator->signature_path) }}"
                                                class="sig-image" alt="Signature"><br>
                                        @endif
                                ...
                                {{-- Diperiksa oleh --}}
                                <tr>
                                    <td class="text-bold text-center" style="vertical-align: middle;">Diperiksa oleh
                                    </td>
                                    <td style="vertical-align: middle;">
                                    ...
                                    <td style="vertical-align: middle; font-size: 8pt;">
                                        @if($trialRm->operationalManager?->signature_path)
                                            <img src="{{ $resolveSigUrl($trialRm->operationalManager->signature_path) }}"
                                                class="sig-image" alt="Signature"><br>
                                        @endif
                                        Tanggal:
                                        {{ in_array($trialRm->approval_status, ['Pending Tahap 2', 'Approved', 'Rejected']) ? $trialRm->updated_at->isoFormat('D MMM Y') : '—' }}<br>
                                        &#9744; Lanjut pengamatan stabilitas (DP/JP)<br>
                                        <span style="margin-left: 12pt;">(lama pengamatan stabilitas)
                                            ................</span>
                                    </td>
                                </tr>
                                {{-- Evaluasi --}}
                                <tr>
                                    <td class="text-bold text-center" style="vertical-align: middle;">
                                        Evaluasi<br><span
                                            style="font-size: 8pt; font-style: italic; font-weight: 400;">(pilih salah
                                            satu)</span>
                                    </td>
