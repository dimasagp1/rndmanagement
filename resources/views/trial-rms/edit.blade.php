                    ...
                    <div class="card-body space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="batch_qty" name="batch_qty"
                                       value="{{ old('batch_qty', $trialRm->batch_qty) }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="packaging_design" name="packaging_design"
                                       value="{{ old('packaging_design', $trialRm->packaging_design) }}"
                        ...
                        <div>
                            ...
                            <textarea id="trial_objective" name="trial_objective" rows="3"
                                      ...
                                      class="form-input">{{ old('trial_objective', $trialRm->trial_objective) }}</textarea>
                        </div>
