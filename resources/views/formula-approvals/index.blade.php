<x-app-layout>
    ...
    <div class="card">
        ...
        <x-empty-state
            icon="approval"
            title="{{ request('search') ? 'Tidak Ada Hasil' : 'Belum Ada Data' }}"
            description="{{ request('search') ? 'Coba kata kunci lain.' : 'Form Approval akan tampil di sini.' }}"
        />
        @else
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($form->approval_status === 'Pending')
                            ...
                            @else
                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold bg-gray-100 text-gray-600">{{ $form->approval_status }}</span>
                            @endif
                        </td>
