                            ...
                            <div class="space-y-2 mb-4">
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 border border-gray-200 rounded-lg">
                                    ...
                                    <div class="flex items-center gap-2 flex-shrink-0">
                                        <a href="{{ Storage::url($doc->file_path) }}" target="_blank" rel="noopener" @click.prevent="openPreview('{{ Storage::url($doc->file_path) }}', '{{ addslashes($doc->file_name) }}', '{{ addslashes($doc->document_type) }}')" class="btn-ghost btn-sm text-xs text-emerald-600 hover:bg-emerald-50 flex items-center gap-1">
