                        ...
                        <div class="space-y-2 mb-4">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 border border-gray-200 rounded-lg">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs font-semibold text-gray-800">{{ $doc->file_name }}</p>
                                        <p class="text-[11px] text-gray-400">{{ $doc->formatted_size }} • {{ $doc->created_at->format('d M Y H:i') }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2">
                                    <a href="{{ Storage::url($doc->file_path) }}" target="_blank" class="btn-ghost btn-sm text-xs text-emerald-600 hover:bg-emerald-50 flex items-center gap-1">
